  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-40 flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-200 bg-white text-zinc-600 shadow-sm transition-colors hover:bg-zinc-50 md:hidden dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-700"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-50 h-full w-72 transform border-r border-zinc-200 bg-white transition-transform duration-300 ease-in-out md:translate-x-0 dark:border-zinc-800 dark:bg-zinc-900 ${
          ...
          <div className="border-t border-zinc-200 p-4 dark:border-zinc-800">
            ...
            <div className="rounded-lg bg-zinc-50 p-3 dark:bg-zinc-800">
              <p className="text-xs text-zinc-500 dark:text-zinc-400">
                Application pour réviser les verbes anglais avec conjugaisons et exemples.
              </p>
            </div>
          </div>
        </div>
